...
INSERT INTO "new_appointments" ("clientId", "created_at", "date", "hour", "id", "is_confirmed", "serviceId") SELECT "clientId", "created_at", "date", "hour", "id", "is_confirmed", "serviceId" FROM "appointments";
